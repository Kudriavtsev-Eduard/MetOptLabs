...
| **Гиперпараметры:**         | \texttt{indent} - половина размера отрезка, который будет рассматриваться относительно заданной точки current_argument.<br>\texttt{n} - количество итераций, которое должен отработать цикл тернарного поиска.                                                                                                                                                                                                                                                                                                                                                                                                                             |
| **Особенности реализации:** | Отсутствуют                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| **Гиперпараметры:**         | \texttt{indent} - половина размера отрезка, который будет рассматриваться относительно заданной точки current_argument<br><br>\texttt{n} - количество итераций, которое долженотработать цикл тернарного поиска.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Особенности реализации:** | Отсутствуют                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
