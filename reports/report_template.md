...
[график](#график-6-fx-y--065-cdot--x---212--11-cdot--y--372---7-cdot--x--12-cdot--y---15)

Объект исследования: $f(x, y) = 0.65 \cdot  (x - 21)^2 + 1.1 \cdot  (y + 37)^2 - 7 \cdot  x + 12 \cdot  y - 15$

Результат:

Алгоритм сошелся в точке минимума. Алгоритм остановился в точке (26.3846, -42.454),
значение функции -657.573
...
Алгоритм сошелся в точке минимума. Алгоритм остановился в точке (-2.805, 3.131),
значение функции 7.935e-16 (+0).
...
Алгоритм предположительно застрял в локальной точке минимума. Алгоритм остановился в точке (-9.999, -7.999),
значение функции 150.853.
