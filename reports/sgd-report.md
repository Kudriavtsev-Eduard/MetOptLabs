...
### График 7 (Keras, Nesterov Momentum)
...
### График 14 (sgd_optimizer + Elastic)
...
[график 1](#график-1-pytorch-модификация-nesterov)
...
[график 2](#график-2-pytorch-модификация-momentum)
...
[график 3](#график-3-pytorch-модификация-adagrad)
...
[график 4](#график-4-pytorch-модификация-rmsprop)
...
[график 5](#график-5-pytorch-модификация-adam)
...
[график 6](#график-6-keras-обычный-sgd)
...
[график 7](#график-7-keras-nesterov-momentum)
...
[график 8](#график-8-keras-adagrad)
...
[график 9](#график-9-keras-rmsprop)
...
[график 10](#график-10-keras-adam)
...
[график 11](#график-11-sgd_optimizer)
...
[график 12](#график-12-sgd_optimizer--l2)

| **Характеристика**                           | **Информация**                                                                                       |
|----------------------------------------------|------------------------------------------------------------------------------------------------------|
| **Модификация:**                             | регуляризация L2                                                                                     |
| **Значения гиперпараметров:**                | Стартовая точка = (0, 0, 0, 0, 0, 0) <br>$indent=1$<br>$count iterations=100$<br>$batch size=32$<br> |
...
[график 13](#график-13-sgd_optimizer--l1)

| **Характеристика**                           | **Информация**                                                                                       |
|----------------------------------------------|------------------------------------------------------------------------------------------------------|
| **Модификация:**                             | регуляризация L1                                                                                     |
| **Значения гиперпараметров:**                | Стартовая точка = (0, 0, 0, 0, 0, 0) <br>$indent=1$<br>$count iterations=100$<br>$batch size=32$<br> |
...
[график 14](#график-14-sgd_optimizer--elastic)

| **Характеристика**                           | **Информация**                                                                                       |
|----------------------------------------------|------------------------------------------------------------------------------------------------------|
| **Модификация:**                             | регуляризация Elastic                                                                                |
| **Значения гиперпараметров:**                | Стартовая точка = (0, 0, 0, 0, 0, 0) <br>$indent=1$<br>$count iterations=100$<br>$batch size=32$<br> |
